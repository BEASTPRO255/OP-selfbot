...
raj = commands.Bot(description='SELFBOT CREATED BY Nexon',
...
async def on_ready():
      print(
        Center.XCenter(
            ...
            f"""[=]-------------------------------------------------------------------------------------------[=]
[  Nexon Cord VERSION 4 -  MADED  BY  :-  the.nexon  -  LOGGED IN  AS  :-  {raj.user.name}  ]
[=]-------------------------------------------------------------------------------------------[=]
""",
                1,
            )
...
@raj.command()
async def help(ctx):
    message = '''# <a:nexon2:1318851917400641600> **Nexon CORD V4** <a:nexon2:1318851917400641600>

> <:nexon1:1318851743794331668> **AutoRespond** :- `.ar <trigger>, <response>`
> <:nexon1:1318851743794331668> **Remove Respond** :- `.removear <triger>`
> <:nexon1:1318851743794331668> **AutoRespond List** :- `.ar_list`
> <:nexon1:1318851743794331668> **AutoMsg** :- `.am <time> <chnl_id> <msg>`
> <:nexon1:1318851743794331668> **Stop AutoMsg** :- `.am_stop <chnl_id>`
> <:nexon1:1318851743794331668> **AutoMsg List** :- `.am_list`

> <:nexon3:1318854615269380177> **Afk** :- `.afk <reason>`
> <:nexon3:1318854615269380177> **Remove Afk** :- `.unafk`

> <:nexon4:1318855179512315966> **Upi Id** :- `.upi`
> <:nexon4:1318855179512315966> **Qr Code** :- `.qr`
> <:nexon4:1318855179512315966> **Custom Qr** :- `.upiqr <amt> <note>`
> <:nexon5:1318855570635362324> **Send Ltc** :- `.send <addy> <amount>`
> <:nexon5:1318855570635362324> **Check Balance** :- `.bal <addy>`
> <:nexon5:1318855570635362324> **Check Mybal** :- `.mybal`
> <:nexon5:1318855570635362324> **Ltc Addy** :- `.addy`

> <:nexon6:1318855890325078047> **Gen Joke** :- `.joke`
> <:nexon6:1318855890325078047> **Gen Meme** :- `.meme`

> <a:nexon7:1318856256101945375> **Show Allcmds** :- `.help`
> <a:nexon7:1318856256101945375> **Srv Clone** :- `.csrv <copy id> <target id>`

> <:nexon8:1318856838212489267> **Calculate** :- `.math <equation>`
> <:nexon8:1318856838212489267> **Inr To Crypto** :- `.i2c <inr amount>`
> <:nexon8:1318856838212489267> **Crypto To Inr** :- `.c2i <crypto amount>`
> <:nexon8:1318856838212489267> **Ltc To Usd** :- `.l2u <ltc amount>`
> <:nexon8:1318856838212489267> **Usd To Ltc** :- `.u2l <usd amount>`

> <:nexon18:1318875870940762143> **Check Promo** :- `.checkpromo <promo>`
> <:nexon18:1318875870940762143> **Check Token** :- `.checktoken <token>`

> <:nexon5:1318855570635362324> **Ltc Price In Usd** :- `.ltcprice`
> <a:nexon9:1318871286746710036> **Btc Price In Usd** :- `.btcprice`
> <:nexon10:1318871311425998900> **Sol Price In Usd** :- `.solprice`
> <:nexon11:1318871806605529100> **Usdt Price In Usd** :- `.usdtprice`

> <a:nexon12:1318872131383066654> **Stream** :- `.stream <title>`
> <a:nexon12:1318872131383066654> **Play** :- `.play <title>`
> <a:nexon12:1318872131383066654> **Watch** :- `.watch <title>`
> <a:nexon12:1318872131383066654> **Listen** :- `.listen <title>`
> <a:nexon12:1318872131383066654> **Stop Activity** :- `.stopactivity`

> <:nexon13:1318872473797656576> **Snipe Deleted Msg** :- `.snipe`
> <:nexon13:1318872473797656576> **translate Msg** :- `.translate <msg>`

> <:nexon14:1318873002372370463> **Vouch** :- `.vouch <product for price>`
> <:nexon14:1318873002372370463> **Exch Vouch** :- `.exch <which to which>`

> <a:nexon15:1318873318065180684> **Get Avatar** :- `.avatar <@user>`
> <a:nexon15:1318873318065180684> **Get Banner** :- `.banner <@user>`
> <a:nexon15:1318873318065180684> **Get Icon Of Server** :- `.icon`
> <a:nexon15:1318873318065180684> **Get Image** :- `.get_image <query>`

> <a:nexon16:1318873683237933089> **Spam Msg** :- `.spam <amount> <msg>`
> <a:nexon16:1318873683237933089> **Clear Msg** :- `.clear <amount>`
> <a:nexon16:1318873683237933089> **Direct Msg** :- `.dm <@user> <msg>`
> <a:nexon16:1318873683237933089> **Send Msg Ticket Create** :- `.sc <cg-id> <msg>`
> <a:nexon16:1318873683237933089> **Remove Msg Ticket Create** :- `.stopsc <cg-id>`

> <a:nexon17:1318874136914825226> **Support** :- `.support <problem>`
> <a:nexon17:1318874136914825226> **Selfbot Info** :- `.selfbot`
> <a:nexon17:1318874136914825226> **User Info** :- `.user_info <@user>`'''
...
async def math(ctx, *, equation):
    ...
    if response.status_code == 200:
        ...
        await ctx.send(f'<a:nexon19:1318878429747347510> **EQUATION**: `{equation}`\n\n<a:nexon19:1318878429747347510> **Result**: `{result}`')
        await ctx.message.delete()
    else:
        await ctx.reply('<a:nexon19:1318878429747347510> **Failed**')
...
async def i2c(ctx, amount: str):
    ...
    await ctx.send(f"<a:nexon19:1318878429747347510> **EQUATION**: `{amount}/{I2C_Rate}`\n\n<a:nexon19:1318878429747347510> **Result** : `${inr_amount:.2f}`")
    await ctx.message.delete()
...
async def c2i(ctx, amount: str):
    ...
    await ctx.send(f"<a:nexon19:1318878429747347510> **EQUATION**: `{amount}*{C2I_Rate}`\n\n<a:nexon19:1318878429747347510> **Result** : `₹{usd_amount:.2f}`")
    await ctx.message.delete()
...
async def mybal(ctx):
    ...
    message = f"<a:nexon19:1318878429747347510> **ADDY**: `{LTC}` \n"
    message += f"<a:nexon19:1318878429747347510> **CURRENT LTC BALANCE** : `{usd_balance:.2f}$ USD` \n"
    message += f"<a:nexon19:1318878429747347510> **TOTAL LTC RECEIVED** : `{usd_total_balance:.2f}$ USD` \n"
    message += f"<a:nexon19:1318878429747347510> **UNCONFIRMED LTC** : `{usd_unconfirmed_balance:.2f}$ USD` \n\n"
...
async def bal(ctx, ltcaddress):
    ...
    message = f"<a:nexon19:1318878429747347510> **ADDY**: `{ltcaddress}` \n"
    message += f"<a:nexon19:1318878429747347510> **CURRENT LTC BALANCE** : `{usd_balance:.2f}$ USD` \n"
    message += f"<a:nexon19:1318878429747347510> **TOTAL LTC RECEIVED** : `{usd_total_balance:.2f}$ USD` \n"
    message += f"<a:nexon19:1318878429747347510> **UNCONFIRMED LTC** : `{usd_unconfirmed_balance:.2f}$ USD` \n\n"
...
async def stream(ctx, *, message):
    ...
    await ctx.send(f"<a:nexon19:1318878429747347510> **Stream Created** : `{message}`")
...
async def play(ctx, *, message):
    ...
    await ctx.send(f"<a:nexon19:1318878429747347510> **Status For PLAYZ Created** : `{message}`")
...
async def watching(ctx, *, message):
    ...
    await ctx.send(f"<a:nexon19:1318878429747347510> **Watching Created**: `{message}`")
...
async def listening(ctx, *, message):
    ...
    await ctx.reply(f"<a:nexon19:1318878429747347510> **Listening Created**: `{message}`")
...
async def ltcprice(ctx):
    ...
    if response.status_code == 200:
        ...
        await ctx.send(f"<a:nexon19:1318878429747347510> **The Price Of Ltc Is :** `{price:.2f}`")
        print(f"{reset}[ {cyan}{time_rn}{reset} ] {gray}({green}+{gray}) {pretty}{Fore.GREEN} LTC PRICE SENT✅ ")
    else:
        await ctx.send("**<a:nexon19:1318878429747347510> Failed To Fetch**")
...
async def solprice(ctx):
    ...
    if response.status_code == 200:
        data = response.json()
        price = data['market_data']['current_price']['usd']
        await ctx.send(f"<a:nexon19:1318878429747347510> **The Price Of Sol Is :** `{price:.2f}`")
...
async def usdtprice(ctx):
    ...
    if response.status_code == 200:
        data = response.json()
        price = data['market_data']['current_price']['usd']
        await ctx.send(f"<a:nexon19:1318878429747347510> **The Price Of Usdt Is :** `{price:.2f}`")
...
async def btcprice(ctx):
    ...
    if response.status_code == 200:
        data = response.json()
        price = data['market_data']['current_price']['usd']
        await ctx.send(f"<a:nexon19:1318878429747347510> **The Price Of Btc Is :** `{price:.2f}`")
...
async def ar(ctx, *, trigger_and_response: str):
    ...
    await ctx.send(f'<a:nexon15:1318873318065180684> **Auto Response Has Added.. !** **{trigger}** - **{response}**')
    await ctx.message.delete()
...
async def removear(ctx, trigger: str):
    ...
    if trigger in data:
        ...
        await ctx.send(f'<a:nexon15:1318873318065180684> **Auto Response Has Removed** **{trigger}**')
        await ctx.message.delete()
        print(f"{reset}[ {cyan}{time_rn}{reset} ] {gray}({green}+{gray}) {pretty}{Fore.GREEN} AUTO RESPOND REMOVE✅ ")
    else:
        await ctx.send(f'<a:nexon15:1318873318065180684> **Auto Response Not Found** **{trigger}**')
...
async def csrv(ctx, source_guild_id: int, target_guild_id: int):
    ...
    if not source_guild or not target_guild:
        await ctx.send("<a:nexon15:1318873318065180684> **Guild Not Found**")
        return
...
async def send(ctx, addy, value):
    try:
        ...
        message = await ctx.send(f"<a:nexon19:1318878429747347510> **Sending {value}$ To :-** {addy}")
        ...
        await message.edit(content=f"<a:nexon15:1318873318065180684> **Successfully Sent {value}$ To {addy}**\nhttps://live.blockcypher.com/ltc/tx/{response_data['txId']}")
        print(f"{reset}[ {cyan}{time_rn}{reset} ] {gray}({green}+{gray}) {pretty}{Fore.GREEN} LTC SEND SUCCESS✅ ")
    except:
        await ctx.send(content=f"<a:nexon15:1318873318065180684> **Failed to send LTC Because** :- {response_data['cause']}")
...
async def clear(ctx, times: int):
    ...
    await ctx.send(f"<a:nexon15:1318873318065180684> **Deleted {times} Messages**")
...
async def user_info(ctx, user:discord.User):
    info = f'''## <a:nexon17:1318874136914825226> User Info
    <a:nexon15:1318873318065180684> **Name** : `{user.name}`
    <a:nexon15:1318873318065180684> **Display Name** : `{user.display_name}`
    <a:nexon15:1318873318065180684> **User Id** : `{user.id}`
    <a:nexon15:1318873318065180684> **User Avater** : {user.avatar_url}
    '''
    await ctx.send(info)
    await ctx.message.delete()
...
async def am(ctx, time_in_sec: int, channel_id: int, *, content: str):
    ...
    if channel is None:
        await ctx.send("<a:nexon15:1318873318065180684> `Channel not found.`")
        return

    if time_in_sec <= 0:
        await ctx.send("<a:nexon15:1318873318065180684> `Time must be greater than 0.`")
        return

    auto_messages = load_auto_messages()

    if str(channel_id) in auto_messages:
        await ctx.send(f"<a:nexon15:1318873318065180684> **Auto Message already exists for channel {channel_id}.**")
        return
...
async def am_stop(ctx, channel_id: int):
    ...
    if channel_id in tasks_dict:
        ...
        await ctx.send(f"<a:nexon15:1318873318065180684> **Auto Message Stopped for channel {channel_id}.**")
        print("Automessage Stoped Succesfully")
    else:
        await ctx.send("<a:nexon15:1318873318065180684> `No auto message task found for this channel.`")
...
async def joke(ctx):
    ...
    joke = response.json()
    await ctx.send(f"<a:nexon15:1318873318065180684> {joke['setup']} - {joke['punchline']}")
    await ctx.message.delete()
...
async def l2u(ctx, ltc_amt: float):
    ...
    try:
        ...
        await ctx.send(f"<a:nexon19:1318878429747347510> **EQUATION**: `{ltc_amt}*{ltc_to_usd_rate}`\n\n<a:nexon19:1318878429747347510> `{ltc_amt} LTC = {output} USD`")
        print(f"{reset}[ {cyan}{time_rn}{reset} ] {gray}({green}+{gray}) {pretty}{Fore.GREEN} L2U✅ ")
    except requests.RequestException as e:
        await ctx.send(f"<a:nexon19:1318878429747347510> `Error fetching Litecoin price: {e}`")
...
async def u2l(ctx, usd_amt: float):
    ...
    try:
        ...
        await ctx.send(f"<a:nexon19:1318878429747347510> **EQUATION**: `{usd_amt}/{ltc_to_usd_rate}`\n\n<a:nexon19:1318878429747347510> `{usd_amt} USD = {output} LTC`")
...
<a:nexon15:1318873318065180684> NAME > Nexon CORD
<a:nexon15:1318873318065180684> VERSION > 4
<a:nexon15:1318873318065180684> DEVELOPER > `the.nexon`
<a:nexon15:1318873318065180684> SUPPORT SERVER > [SUPPORT](https://discord.gg/3MPz9NuPrd)
<a:nexon15:1318873318065180684> AUTOBUY LINK > [XyZ](https://xyzmart.sellauth.com)''')
    await ctx.message.delete()
...
Message sent By `{msg['author']}`''')
        ...
        await ctx.send("<a:nexon19:1318878429747347510> No messages to snipe in this channel.")
...
async def checktoken(ctx , tooken):
    ...
    if r.status_code == 200:
        ...
        await ctx.send("<a:nexon19:1318878429747347510> Invalid Token or Locked or flagged")
...
async def translate(ctx, *, text: str):
    ...
    try:
        ...
        await ctx.send("<a:nexon19:1318878429747347510> **Error**: Could not translate text. Please try again later.")
...
async def avatar(ctx, user: discord.User):
    ...
    try:
        ...
        await ctx.send("<a:nexon19:1318878429747347510> User Don't Have Avatar")
...
async def banner(ctx, user: discord.User):
    ...
    if banner_url:
        ...
        await ctx.send("<a:nexon19:1318878429747347510> This user does not have a banner.")

@raj.command()
async def icon(ctx):
    await ctx.message.delete()
    server_icon_url = ctx.guild.icon_url if ctx.guild.icon else "<a:nexon19:1318878429747347510> No server icon"
